---
title: 'Série d’illustrations communication musicale'
description: "Création graphique et recherche de pistes visuelles pour la communication d’événements culturels, dans le cadre de la SAE5.Crea.01"
pubDate: '2025-10'
heroImage: '/flyerspsThumbnail.jpg'
tags: ['illustration', 'création graphique', 'musique', 'communication', 'MMI']
auteur: "Nathan DEJEAN"
---

### Contexte

Dans le cadre de la SAE5.Crea.01, ce projet propose un travail de création graphique autour d’événements musicaux, mêlant inspirations rock, électro et culture locale. Après des recherches sur différentes références visuelles et artistiques, plusieurs pistes ont été testées, notamment une direction d’inspiration techno-électro, où modernité et codes classiques se mêlent (vibrance, collage, couleurs fortes).
